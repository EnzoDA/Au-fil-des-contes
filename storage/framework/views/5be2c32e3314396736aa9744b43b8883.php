...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?php echo e(route('caverne.index')); ?>">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="<?php echo e(route('caverne.index')); ?>">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="<?php echo e(route('commentaire.index')); ?>">
                    <i class="fas fa-fw fa-tachometer-alt"></i>
...
</html><?php /**PATH C:\laragon\www\AUFILDESCOMPTES\Au-fil-des-comptes\resources\views/template.blade.php ENDPATH**/ ?>